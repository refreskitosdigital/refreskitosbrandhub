...
export default async function GlobalPlaceholderPage() {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center text-center p-8">
      ...
      <h1 className="text-3xl font-syne font-bold text-text mb-4">Vista Global No Disponible</h1>
      <p className="text-text-dim max-w-md mx-auto">
        Para ver o editar la Parrilla de Contenidos, por favor selecciona una marca en el menú superior (Workspace actual).
      </p>
    </div>
  );
}
